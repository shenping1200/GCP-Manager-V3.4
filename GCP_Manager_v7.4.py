...
APP_USER_MODEL_ID = "xiaolong.gcp.manager.v7.4"
...
class GCPManagerApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("GCP批量管理工具v7.4 - 渔夫出品 - Telegram：@yufu220")
        ...
        self.log_signal.emit("GCP Manager v7.4 启动成功 | 创建后自动执行命令已启用")
...
if __name__ == "__main__":
    ...
    print("GCP Manager v7.4 (基于v7.3 + HTTP/HTTPS开放 + 全开防火墙)")
