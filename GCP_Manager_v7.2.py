...
APP_USER_MODEL_ID = "xiaolong.gcp.manager.v7.2"
...
class GCPManagerApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("GCP批量管理工具v7.2 - 渔夫出品 - Telegram：@yufu220")
        ...
        self.log_signal.emit("GCP Manager v7.2 启动成功 | 创建后自动执行命令已启用")
    ...
    def init_bottom_panel(self):
        ...
        # 无最低高度限制，用户可自由拖动
        self.log_area.setPlaceholderText("运行日志会显示在这里... [7.2 创建后自动执行命令]")
...
if __name__ == "__main__":
    ...
    print("GCP Manager v7.2 (基于v6.9 + 创建后自动执行命令)")
